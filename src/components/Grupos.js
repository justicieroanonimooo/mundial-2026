...
const todosLosPartidos = {
  A: [
    ...
    { id: 5, local: 'México', visita: 'República Checa' },
  ...
  C: [
    ...
    { id: 16, local: 'Marruecos', visita: 'Escocia' },
  ...
  D: [
    ...
    { id: 22, local: 'Paraguay', visita: 'Turquía' },
    { id: 23, local: 'EE. UU.', visita: 'Turquía' },
  ...
  E: [
    ...
    { id: 28, local: 'Curazao', visita: 'Ecuador' },
    { id: 29, local: 'Alemania', visita: 'Ecuador' },
  ...
  F: [
    ...
    { id: 34, local: 'Japón', visita: 'Túnez' },
    { id: 35, local: 'Países Bajos', visita: 'Túnez' },
    { id: 36, local: 'Japón', visita: 'Suecia' },
  ],
  G: [
    { id: 37, local: 'Bélgica', visita: 'Egipto' },
    { id: 38, local: 'Irán', visita: 'Nueva Zelanda' },
    { id: 39, local: 'Bélgica', visita: 'Irán' },
    { id: 40, local: 'Egipto', visita: 'Nueva Zelanda' },
    { id: 41, local: 'Bélgica', visita: 'Nueva Zelanda' },
    { id: 42, local: 'Egipto', visita: 'Irán' },
  ],
  H: [
    { id: 43, local: 'España', visita: 'Cabo Verde' },
    { id: 44, local: 'Arabia Saudí', visita: 'Uruguay' },
    { id: 45, local: 'España', visita: 'Arabia Saudí' },
    { id: 46, local: 'Cabo Verde', visita: 'Uruguay' },
    { id: 47, local: 'España', visita: 'Uruguay' },
  ...
  I: [
    ...
    { id: 52, local: 'Senegal', visita: 'Noruega' },
    { id: 53, local: 'Francia', visita: 'Noruega' },
  ...
  J: [
    ...
    { id: 58, local: 'Argelia', visita: 'Jordania' },
    { id: 59, local: 'Argentina', visita: 'Jordania' },
  ...
  K: [
    ...
    { id: 64, local: 'R.D. del Congo', visita: 'Colombia' },
    { id: 65, local: 'Portugal', visita: 'Colombia' },
  ...
  L: [
    ...
    { id: 70, local: 'Croacia', visita: 'Panamá' },
    { id: 71, local: 'Inglaterra', visita: 'Panamá' },
          ...
          <tbody>
            {tabla.map((equipo, i) => (
              <tr key={equipo.nombre} style={{
                ...
                <td style={{ padding: '12px', fontWeight: 'bold', color: tema.texto, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{equipo.nombre}</td>
